...
# Wrap the Streamlit app logic within a 'show' function
def show():
    ...
    if data is not None:
        ...
        if filled_data is not None: # This check is redundant here because it's already within if data is not None:
...
# The if __name__ == "__main__": block is typically used for running a script directly.
# Since this file is intended to be imported as a module (e.g., from anomaly import show),
# you generally wouldn't call show() directly here unless you want to be able to run this
# specific file as a standalone Streamlit app as well.
# For your current setup where main.py imports show_anomaly, you don't need to call show() here.
